...
public class PullBodyScript : MonoBehaviour
{
    ...
    public void SearchEnemyBody()
    {
        ...
        Debug.DrawRay(Origin, Direction, Color.red , ControlerPlayer.CameraPlayerF3.CurrentMoveBackDistance);

        if (Physics.Raycast(Origin, Direction, out RaycastHit HitResult , ControlerPlayer.CameraPlayerF3.CurrentMoveBackDistance, 6))
        {
